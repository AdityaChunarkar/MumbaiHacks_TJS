      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6 h-2 bg-gray-200 rounded-full overflow-hidden">
            <div className="h-full w-4/5 bg-primary rounded-full transition-all duration-500"></div>
          </div>
          ...
          <p className="text-center text-gray-600 text-sm mb-6">
            We use this information to provide you with a personalized experience.
          </p>

          {/* Title */}
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-2">
            Tell us about your ongoing Loan amount
          </h2>
          ...
          <form className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="loan-amount">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="loan-type">
              ...
              <input 
                ...
                name="loan-type" 
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition"
                placeholder="e.g., Home, Auto, Personal"
              />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2" htmlFor="loan-duration">
                What is the duration of your loan?
              </label>
              <input 
                type="text" 
                id="loan-duration" 
                name="loan-duration" 
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition"
                placeholder="e.g., 5 years, 360 months"
              />
            </div>

            <button 
              type="button"
              onClick={() => window.location.href = '/detailsThree'}
